...
\caption{{\bf Peristalsis and lateral oscillations’ rhythmic activities appear decoupled.}(Continued)
 \label{fig:FigS2}}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=-90,width=145mm]{figures/FigS2_correlation_plot_BMP.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[angle=-90,width=145mm]{figures/FigS3Ex_gain_-20_-100_BMP.pdf}
